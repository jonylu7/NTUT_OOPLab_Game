...
void SpriteSheetAnimation::initSpriteSheetAnimation(std::shared_ptr<SpriteSheet> spriteSheet, bool play,std::size_t interval, bool looping=true, std::size_t cooldown=100){
    m_State=play ? State::PLAY : State::PAUSE;
    m_Interval=interval;
    m_Looping=looping;
    m_Cooldown=cooldown;
