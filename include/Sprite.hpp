...
public:
    Sprite(std::shared_ptr<Util::Image>texture){
         ...
         * the textureCoord vector is defined counter clock wise, starting from the top right corner.
         */
        m_Texture=texture;
        m_TextureCoord={
            glm::vec2(1,1),
    ...
    Sprite(std::shared_ptr<Util::Image>texture,std::vector<glm::vec2>textureCoord){
        m_Texture=texture;
